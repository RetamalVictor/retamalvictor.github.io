...
import { InfoPanelController } from './managers/InfoPanelController.js';
import { ExpandableDemo } from './managers/ExpandableDemo.js';
...
class Portfolio {
    ...
    private infoPanel: InfoPanelController | null = null;
    private expandableDemo: ExpandableDemo | null = null;
    ...
    private setupThreeViewers(): void {
        try {
            ...
            this.demoManager = new DemoManager('hero-three-scene');

            // Initialize info panel controller
            this.infoPanel = new InfoPanelController();
            this.infoPanel.initialize();

            // Initialize expandable demo
            this.expandableDemo = new ExpandableDemo('demo-section');
            this.expandableDemo.initialize();

            // Wire up demo change to update info panel
            this.demoManager.onDemoChanged((demoType) => {
                this.infoPanel?.setContent(demoType);
            });
