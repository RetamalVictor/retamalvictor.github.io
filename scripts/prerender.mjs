...
function generateLlmsTxt() {
  ...
  const lines = [
    '# Victor Retamal',
    '',
    '> Machine Learning & Robotics Engineer. Currently teaching machines to think',
    '> and move: designing intelligent systems that learn from the world and act',
    '> in it.',
    '',
    ...
    '- Education: MSc Artificial Intelligence, Vrije Universiteit Amsterdam and',
    '  University of Amsterdam',
    '- Works on: sim-to-real robotics, multi-agent reinforcement learning, model',
    '  predictive control, neural network quantization, computer vision, 3D medical',
    '  image segmentation',
